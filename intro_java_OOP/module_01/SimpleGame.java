...
public class SimpleGame {
	...
	public String convertTime(int seconds){
		...
		if (seconds > 0){
			...
			// Create result string, print and return it
			String result = hours + ":" + mins + ":" + secs;
			System.out.println(result);
			return result;
		}
	...
	public static void main(String[] args) {
		...
		System.out.println("Enter 1 for convertTime and 2 for digitsSum:");
		...
		if (choice == 1) {
			...
			System.out.println("Enter integer of seconds to convert:");
			...
			System.out.println("Enter integer of number to sum digits for:");
